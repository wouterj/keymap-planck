 ...
 * |------+------+------+------+------+------+------+------+------+------+------+--------------|
 * | Ctrl |Brite | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right / Ctrl  |
 * `-------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, BACKLIT, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   RCTL_T(KC_RGHT)
),
